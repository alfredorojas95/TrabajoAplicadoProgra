...
public class CrearEstudianteTest {
	...
	public void testAgregarNuevoEstudiante() {
		 ...
		 */
		String resultado="";
		resultado = Estudiante.agregarNuevoEstudiante("Henry","Gatica","155457671","123456","142749802");
		resultado = Estudiante.agregarNuevoEstudiante("Matias","Torres","145457681","123456","142749802");
