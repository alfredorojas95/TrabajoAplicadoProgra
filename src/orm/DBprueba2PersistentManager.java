...
public class DBprueba2PersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "DBprueba2";
	...
	private DBprueba2PersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new DBprueba2PersistentManager();
		}
